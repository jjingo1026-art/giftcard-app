...
export default function MobileBusinessInfo() {
          ...
          <div className="px-5 py-4 space-y-3">
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-[13px] font-bold text-white">전화걸기</p>
                  <p className="text-[11px] text-white opacity-80 mt-0.5">{biz.phone}</p>
                </div>
              </div>
