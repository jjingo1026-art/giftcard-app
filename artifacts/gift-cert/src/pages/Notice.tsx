...
const DEFAULT_NOTICE_DATA: Record<string, { title: string; sub?: string; rate: number; desc: string[] }> = {
  "신세계백화점상품권": { title: "신세계백화점상품권", rate: 95, desc: ["신세계백화점 전 지점에서 사용 가능한 상품권입니다.", "유효기간 없이 사용 가능합니다.", "상품권가격의 95%로 매입합니다."] },
  "롯데백화점상품권": { title: "롯데백화점상품권", rate: 95, desc: ["롯데백화점 전 지점에서 사용 가능한 상품권입니다.", "유효기간 없이 사용 가능합니다.", "상품권가격의 95%로 매입합니다."] },
  "현대백화점상품권": { title: "현대백화점상품권", rate: 95, desc: ["현대백화점 전 지점에서 사용 가능한 상품권입니다.", "유효기간 없이 사용 가능합니다.", "상품권가격의 95%로 매입합니다."] },
  "국민관광상품권": { title: "국민관광상품권", rate: 95, desc: ["전국 관광지, 호텔, 여행사 등에서 사용 가능한 상품권입니다.", "유효기간 확인 후 매입합니다.", "상품권가격의 95%로 매입합니다."] },
  "갤러리아백화점상품권": { title: "갤러리아백화점상품권", rate: 94, desc: ["갤러리아백화점에서 사용 가능한 상품권입니다.", "유효기간 없이 사용 가능합니다.", "상품권가격의 94%로 매입합니다."] },
  "삼성상품권": { title: "삼성상품권", rate: 92, desc: ["삼성전자 제품 구매 시 사용 가능한 상품권입니다.", "삼성 공식 스토어 및 온라인몰에서 사용 가능합니다.", "상품권가격의 92%로 매입합니다."] },
  "이랜드상품권": { title: "이랜드상품권", rate: 91, desc: ["이랜드 계열 브랜드 및 매장에서 사용 가능합니다.", "NC백화점, 뉴코아아울렛 등에서 사용 가능합니다.", "상품권가격의 91%로 매입합니다."] },
  "AK(애경)상품권": { title: "AK(애경)상품권", rate: 91, desc: ["AK플라자(애경백화점) 매장에서 사용 가능합니다.", "유효기간 없이 사용 가능합니다.", "상품권가격의 91%로 매입합니다."] },
  "농협상품권": { title: "농협상품권", rate: 91, desc: ["농협 하나로마트 및 제휴 가맹점에서 사용 가능합니다.", "농산물 구매에도 사용 가능합니다.", "상품권가격의 91%로 매입합니다."] },
  "지류문화상품권": { title: "지류문화상품권", sub: "컬쳐랜드 · 북앤라이프 · 문화상품권", rate: 90, desc: ["컬쳐랜드, 북앤라이프, 문화상품권이 해당됩니다.", "온·오프라인 다양한 가맹점에서 사용 가능합니다.", "상품권가격의 90%로 매입합니다."] },
  "온누리상품권": { title: "온누리상품권", rate: 90, desc: ["전통시장 및 골목형 상점가에서 사용 가능합니다.", "지류형과 전자형(카드·모바일) 구분 없이 매입합니다.", "상품권가격의 90%로 매입합니다."] },
  "주유권": { title: "주유권", sub: "SK · GS · 현대 · S-OIL", rate: 95, desc: ["SK, GS, 현대, S-OIL 주유소에서 사용 가능합니다.", "유효기간 확인 후 매입합니다.", "상품권가격의 95%로 매입합니다."] },
};
              ...
              for (const [label, pct] of Object.entries(apiRates)) {
                if (updated[label]) {
                  ...
                  const desc = updated[label].desc.map((d) =>
                    d.replace(/상품권가격의 \d+(\.\d+)?%로 매입합니다\./, `상품권가격의 ${newRate}%로 매입합니다.`)
                  );
