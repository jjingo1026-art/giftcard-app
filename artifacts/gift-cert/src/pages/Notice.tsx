const NOTICE_DATA: Record<string, { title: string; sub?: string; rate: number; desc: string[] }> = {
  ...
  "삼성상품권": {
    ...
    rate: 92,
    desc: [
      "삼성전자 제품 구매 시 사용 가능한 상품권입니다.",
      "삼성 공식 스토어 및 온라인몰에서 사용 가능합니다.",
      "액면가의 92%로 매입합니다.",
    ],
  },
  "이랜드상품권": {
    ...
    rate: 91,
    desc: [
      "이랜드 계열 브랜드 및 매장에서 사용 가능합니다.",
      "NC백화점, 뉴코아아울렛 등에서 사용 가능합니다.",
      "액면가의 91%로 매입합니다.",
    ],
  },
  "AK(애경)상품권": {
  ...
  "온누리상품권": {
    ...
    rate: 90,
    desc: [
      "전통시장 및 골목형 상점가에서 사용 가능합니다.",
      "지류형과 전자형(카드·모바일) 구분 없이 매입합니다.",
      "액면가의 90%로 매입합니다.",
    ],
  },
  "주유권": {
